...
**Веб-приложение для тактического планирования и командной работы: карта с метками, канбан задач, сообщения, профиль и гибкая иерархия (военная / корпоративная). Поддерживает светлую и тёмную тему и кастомные цвета. Приложение доступно на руссском и английском языках**
- Vue 3 - современный реактивный фреймворк
- Vite 7 - быстрый сборщик модулей
